...
"""
Doc
Add START_ and _END token to the target sentence is very useful for training and during inference. 
These tags help to know when to start the translation and when to end the translation.
"""
